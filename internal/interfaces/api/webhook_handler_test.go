...
func (m *mockProjectRepoWebhook) FindByID(id uint) (*domain.Project, error) { return m.projects[id], nil }
...
func (m *mockDeployRepoWebhook) FindByProjectID(projectID uint) ([]*domain.Deployment, error) { return nil, nil }
func (m *mockDeployRepoWebhook) FindByID(id uint) (*domain.Deployment, error) { return nil, nil }
func (m *mockDeployRepoWebhook) FindByEnvID(envID uint) ([]*domain.Deployment, error) { return nil, nil }
...
func TestWebhookHandler_HandleGitHubPush(t *testing.T) {
	...
	if rr.Code != http.StatusOK {
		t.Fatalf("expected 200 OK with valid signature, got %d", rr.Code)
	}
}
